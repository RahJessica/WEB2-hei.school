        ...
        <div className='flex flex-col px-50 py-20'>
            <div className='flex flex-row gap-25 '>
                ...
                <div className='w-[50vw] text-[var(--blue_color)] gap-10 flex flex-col justify-center'>
                    ...
                    <button className='border-solid border-3 border-[var(--blue_color)] px-2 py-2 w-[13vw] cursor-pointer text-xl font-semibold hover:bg-[var(--blue_color)] hover:text-white rounded-sm'>Notre programme</button>
                </div>
            </div>
